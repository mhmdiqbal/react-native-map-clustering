...
const ClusteredMapView = forwardRef(
  (
    {
      radius = ClusteredMapView.defaultProps.radius,
      maxZoom = ClusteredMapView.defaultProps.maxZoom,
      minZoom = ClusteredMapView.defaultProps.minZoom,
      minPoints = ClusteredMapView.defaultProps.minPoints,
      extent = ClusteredMapView.defaultProps.extent,
      nodeSize = ClusteredMapView.defaultProps.nodeSize,
      children,
      onClusterPress = ClusteredMapView.defaultProps.onClusterPress,
      onRegionChangeComplete = ClusteredMapView.defaultProps.onRegionChangeComplete,
      onMarkersChange = ClusteredMapView.defaultProps.onMarkersChange,
      preserveClusterPressBehavior = ClusteredMapView.defaultProps.preserveClusterPressBehavior,
      clusteringEnabled = ClusteredMapView.defaultProps.clusteringEnabled,
      clusterColor = ClusteredMapView.defaultProps.clusterColor,
      clusterTextColor = ClusteredMapView.defaultProps.clusterTextColor,
      clusterFontFamily,
      spiderLineColor = ClusteredMapView.defaultProps.spiderLineColor,
      layoutAnimationConf = ClusteredMapView.defaultProps.layoutAnimationConf,
      animationEnabled = ClusteredMapView.defaultProps.animationEnabled,
      renderCluster,
      tracksViewChanges = ClusteredMapView.defaultProps.tracksViewChanges,
      spiralEnabled = ClusteredMapView.defaultProps.spiralEnabled,
      superClusterRef = ClusteredMapView.defaultProps.superClusterRef,
      ...restProps
    },
    ref
  ) => {
